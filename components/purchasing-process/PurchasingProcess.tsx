...
const PurchasingProcess = () => {
  return (
    <div className="flex flex-col items-center justify-center w-full mt-6 mb-12">
      <h1 className="text-4xl font-bold">Købs Processen</h1>
      <div className="grid grid-cols-4 gap-4 mt-10">
        <div className="flex flex-col items-center">
          <HiCursorClick className="w-8 h-8 " />
